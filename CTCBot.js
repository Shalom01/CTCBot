...
bot.on('message', message =>{
    ...
    switch(args[0]){
        ...
        break;
        case 'commands':
            message.channel.send("I am at your service. Say \'hello\' or ask me for \'info\', the course \'outline\' or about my 'bestfriend'.")
        break;
        case 'bicycle':
